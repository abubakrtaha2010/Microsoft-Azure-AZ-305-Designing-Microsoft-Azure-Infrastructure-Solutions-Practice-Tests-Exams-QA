...
- [x] The role-based access control (RBAC) roles required to perform the remediation task.
...
- [x] A user delegation shared access signature (SAS) and a stored access policy.
...
- [x] A linked storage account for the Log Analytics workspace.
